...
namespace SymmetricDifferenceFinder.Decoders
{
	...
	public class HPWDecodingState<TSketch>
		where TSketch : ISketch
	{
		public HashSet<Key> DecodedValues = new HashSet<Key>();
		public TSketch Sketch;
		public List<Key> Pure = new List<ulong>();

		public HPWDecodingState(TSketch sketch)
		{
			Sketch = sketch;
		}
	}
	public class HPWDecoderHelper
	{
		public static Expression<Func<Hash, TSketch, bool>> LooksPure<TSketch>(HashingFunctions hashingFunctions)
			where TSketch : ISketch
		{
