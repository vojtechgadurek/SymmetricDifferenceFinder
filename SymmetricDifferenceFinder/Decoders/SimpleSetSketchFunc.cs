...
namespace SimpleSetSketching.Sketchers
{
	static public class SimpleSetSketchFunc
	{
		...
		public static Expression<Func<ulong, TSketch, bool>> LooksPure<TSketch>(HashingFunctions hashingFunctions)
			where TSketch : ISketch
		{
			var f = CompiledFunctions.Create<ulong, TSketch, bool>(out var hash_, out var table_);
